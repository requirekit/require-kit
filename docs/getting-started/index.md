...
2. Learn [EARS Notation](../core-concepts/ears-notation.md)
3. Try [Your First Requirements](first-requirements.md)
...
👉 **New to RequireKit?** Start with the [Quickstart Guide](quickstart.md)

👉 **Ready to install?** Follow the [Installation Guide](installation.md)

👉 **Want to understand concepts first?** Read about [EARS Notation](../core-concepts/ears-notation.md)

---

**Questions?** Check the [FAQ](../faq.md) or [Troubleshooting Guide](../troubleshooting/index.md)
